...
function toggle() {
    ...
    if ((image_element.src).match("image1_2")) {
        image_element.src = "images/image1.jpg";
    ...
    if ((image_element2.src).match("image2_2")) {
        image_element2.src = "images/image2.jpg";

    } else {
        image_element2.src = "images/image2_2.jpg";
    }
    if ((image_element3.src).match("image3_2")) {
        image_element3.src = "images/image3.jpg";

    } else {
        image_element3.src = "images/image3_2.jpg";
    }
    if ((image_element4.src).match("image4_2")) {
        image_element4.src = "images/image4.jpg";
    ...
    if ((image_element5.src).match("image5_2")) {
        image_element5.src = "images/image5.jpg";
